...
### *Building high-performance web, mobile & desktop applications.*
📍 South Tyrol, Italy 🏔️
...
<table>
  <tr>
    ...
    <td width="33%" valign="top">
      ...
      <p align="left">Android application built in cooperation with <b>AFI-IPL South Tyrol</b>. Includes work-time tracking, an interactive labor rights handbook, and direct contact gateways to union experts.</p>
      <p align="center">
    ...
    <td width="33%" valign="top">
      ...
      <p align="left">A Minecraft-inspired 3D voxel engine built entirely from scratch. Features custom infinite world generation algorithms, a modular block system, and real-time rendering via OpenGL.</p>
      <p align="center">
...
> I bridge the gap between high-level web architectural design and low-level system performance. Whether orchestrating scalable modern web apps or writing memory-efficient compiled code, I choose the right tool for the job.
